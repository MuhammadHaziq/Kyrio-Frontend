      ...
      <CCollapse show={collapse[0]}>
        <CCardBody>
          <CRow>
            <CCol xs="12">
              <CFormGroup>
                                ...
                                <CInput id="businessName" placeholder="Enter your Busniess Name" name='businessName' required />
                              </CFormGroup>
            </CCol>
          </CRow>
          <CRow>
            <CCol xs="12">
              <CFormGroup>
                                ...
                                <CInput id="businessDetail" placeholder="Enter your Busniess Detail" name='businessDetail' required />
                              </CFormGroup>
                              <p>Add billing address, tax ID or other information you need on your invoices</p>
          ...
          <CRow>
            ...
            <CCol xs="4" className="text-center mt-3">
              <CButton size='lg' color="success" className="pull-right btn-pill btn-block" variant="outline" onClick={saveBusinessDetail}>
                SAVE
              </CButton>
            </CCol>
          </CRow>
