                ...
                //   let mod = module.filter(itm => itm.backoffice.title === "View sales report")
                //   if(!mod[0].enable){
                ...
                // if(nav[0].name === "Items"){ 
                //   let mod = module.filter(itm => itm.backoffice.title === "Items")
                //   if(!mod[0].enable){
                ...
                //   let mod = module.filter(itm => itm.backoffice.title === "Manage employees")
                //   if(!mod[0].enable){
                ...
                //   let mod = module.filter(itm => itm.backoffice.title === "Manage customers")
                //   if(!mod[0].enable){
